<x-panel-layout>
    <x-slot name="title">{{ __('Child Home') }}</x-slot>
                                    ...
                                    <div class="tm-calendar-item flex-between items-center">
                                        ...
                                        <div class="right flex-end items-center">
                                            ...
                                            @if(!$submission = $activite->submission()->first())
                                                <a href="#modalSendSubmission{{$activite->id}}"
                                                   data-bs-target="#modalSendSubmission{{$activite->id}}"
                                                   data-bs-toggle="modal" class="btn btn-primary">
                                                    <i class="ri-upload-cloud-line"></i>
                                                    Send Submission
                                                </a>
                                                <x-send_submission id="{{$activite->id}}" title="{{$activite->title}}"/>
                                            @else
