<div class="modal fade" id="modalPayment{{$id}}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">

                <h4 class="mb-3">Payment - £{{ number_format($price, 0) }}</h4>

                <form action="{{ route('update.credit', $id) }}" method="post" class="loading">
                    @csrf
