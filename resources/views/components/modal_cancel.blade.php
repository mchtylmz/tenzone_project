<div class="modal fade tm-modal-cancel" id="modalCancel{{$id}}" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-footer">
                <div class="row">
                    ...
                    <div class="col-6 ps-1">
                        <form action="{{ route('meet.cancel', $id) }}" method="post" onsubmit="return confirm('{{ __('Are you sure you want to Cancel?') }}')">
                            @csrf
